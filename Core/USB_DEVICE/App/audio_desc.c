...
const uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZE] __attribute__((aligned(4))) =
    {
        ...
        // As AudioControl Endpoint Descriptors see Audio 20 section 4.8
        // As Standard AC Interrupt Endpoint Descriptor see Audio 20 section 4.8.2.1
        7u,                            // 0 bLength 1 Number Size of this descriptor, in bytes: 7
        CS_ENDPOINT,                   // 1 bDescriptorType 1 Constant ENDPOINT descriptor type
